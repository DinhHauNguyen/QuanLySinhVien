var Validation = function () {
    ...
    this.kiemTraEmail = function (value, selectorError) {
        ...
        document.querySelector(selectorError).innerHTML = 'Email nhập không hợp lệ';
        document.querySelector(selectorError).style.display = 'block';
        return false;
    }
    this.kiemTraDiem = function (value, selectorError) {
        ...
        document.querySelector(selectorError).innerHTML = 'Không được nhập chữ và kí tự đặc biệt';
        document.querySelector(selectorError).style.display = 'block';
        return false;
    }
